...
class AftChartPage extends StatefulWidget {
  AftChartPage({this.afts, this.soldier});
  final List<Aft>? afts;
  final String? soldier;

  @override
  _AftChartPageState createState() => _AftChartPageState();
}

class _AftChartPageState extends State<AftChartPage> {
  bool mdl = false, hrp = false, sdc = false, plk = false, run = false;
            ...
            children: <Widget>[
              Container(
                ...
                child: Column(
                  children: <Widget>[
                    Text(
                      'AFT Progress for ${widget.soldier}',
                    ...
                    MyLineChart(
                      minY: mdl || hrp || sdc || plk || run ? 0 : 200,
                      maxY: 500,
                      dates: dates,
                      lineBarData: [
                        LineChartBarData(
